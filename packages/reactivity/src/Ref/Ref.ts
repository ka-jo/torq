...
/**
 * The `Ref` interface is the core reactive object in Torq. A ref instance holds a value
 ...
 * - Torq refs have more functionality than the Signal described in the proposal; they
 ...
 * consumer better. To this end, Torq's refs can be thought of as the union of "signals" and
